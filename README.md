...
3. Stores the graph as a 5×5 adjacency matrix
4. Uses brute-force subset search (1–31) to find the maximum clique
5. Prints results to Terminal and output.txt file
