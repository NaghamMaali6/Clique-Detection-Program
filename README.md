...
*Features:
1. Reads graph data from a .txt file
2. Validates that the matrix:
   Contains only 0 and 1

   Has exactly 5 rows and 5 columns
4. Stores the graph as a 5×5 adjacency matrix
5. Uses brute-force subset search (1–31) to find the maximum clique
6. Prints results to Terminal and output.txt file
